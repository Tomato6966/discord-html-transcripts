import { Collection, DMChannel, TextChannel, ThreadChannel, VoiceChannel, type Message, type TextBasedChannel } from 'discord.js';
 ...
 */
export declare function generateFromMessages<T extends ExportReturnType = ExportReturnType.Attachment>(messages: Message[] | Collection<string, Message>, channel: DMChannel | TextChannel | ThreadChannel | VoiceChannel, options?: GenerateFromMessagesOptions<T>): Promise<ObjectType<T>>;
/**
 *
