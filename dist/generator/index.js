...
async function renderMessages(_a) {
    ...
    const elements = (react_1.default.createElement(discord_components_react_1.DiscordMessages, { style: { minHeight: '100vh' } },
        react_1.default.createElement(discord_components_react_1.DiscordHeader, { guild: channel instanceof discord_js_1.DMChannel ? 'Direct Messages' : channel.guild.name, channel: channel instanceof discord_js_1.DMChannel ? (_c = (_b = channel.recipient) === null || _b === void 0 ? void 0 : _b.tag) !== null && _c !== void 0 ? _c : 'Unknown Recipient' : channel.name, icon: channel instanceof discord_js_1.DMChannel ? undefined : (_d = channel.guild.iconURL({ size: 128 })) !== null && _d !== void 0 ? _d : undefined }, channel.isThread()
    ...
    return server_1.default.renderToStaticMarkup(react_1.default.createElement("html", null,
        react_1.default.createElement("head", null,
            ...
            react_1.default.createElement("link", { rel: "icon", type: "image/png", href: options.favicon === 'guild'
                    ? channel instanceof discord_js_1.DMChannel
                        ? undefined
                        : (_g = channel.guild.iconURL({ size: 16, format: 'png' })) !== null && _g !== void 0 ? _g : undefined
                    : options.favicon }),
            react_1.default.createElement("title", null, channel instanceof discord_js_1.DMChannel ? 'Direct Messages' : channel.name),
