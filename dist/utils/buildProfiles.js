...
function buildProfile(member, author) {
    ...
    return {
        ...
        bot: author.bot,
        verified: (_k = (_j = (_h = (_g = author.flags) === null || _g === void 0 ? void 0 : _g.toArray) === null || _h === void 0 ? void 0 : _h.call(_g)) === null || _j === void 0 ? void 0 : _j.includes) === null || _k === void 0 ? void 0 : _k.call(_j, "VERIFIED_BOT"),
    };
}
