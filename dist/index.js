...
async function generateFromMessages(messages, channel, options = {}) {
    ...
    const html = await (0, generator_1.default)({
        ...
        callbacks: Object.assign({ resolveChannel: async (id) => channel.client.channels.fetch(id).catch(() => null), resolveUser: async (id) => channel.client.users.fetch(id).catch(() => null), resolveRole: channel instanceof discord_js_1.DMChannel ? () => null : async (id) => { var _a; return (_a = channel.guild) === null || _a === void 0 ? void 0 : _a.roles.fetch(id).catch(() => null); } }, ((_b = options.callbacks) !== null && _b !== void 0 ? _b : {})),
    ...
    return new discord_js_1.MessageAttachment(Buffer.from(html), (_e = options.filename) !== null && _e !== void 0 ? _e : `transcript-${channel.id}.html`);
}
